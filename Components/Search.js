    ...
    return (
        <>
            <form class="form-inline" style={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
                <input ref={inputRef} onChange={handleThrottleSearch} class="form-control mr-sm-2" style={{ border: "1px solid grey" }} type="search" placeholder="Search" aria-label="Search" />
                ...
                <div class="dropdown">
                    ...
                    {!searchDropdown && <div><h6>Select The Filter</h6></div>}
                </div>
            </form>
            <div style={{
            ...
            <div>
                <div>
                    <div style={{ display: "flex", gap: "5px", width: "100%", justifyContent: "center", marginBottom: "30px" }}>
                        ...
                        {paginationData !== null && paginationData?.length !== 0 ?
